    ...
    items: [
      ...
      { href: "/patients", label: "Patients", icon: PawPrint },
      {
        ...
        children: [
          ...
          { href: "/admin/billing/invoices", label: "Invoices", icon: DollarSign },
        ],
      },
    ],
  },
      ...
      <div className="relative border-b border-border bg-gradient-to-br from-primary to-primary/80 p-4 text-primary-foreground">
        {!sidebarCollapsed && (
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-semibold text-white">Vet Clinic</h2>
      ...
      <nav className="flex-1 p-3">
        {sidebarCollapsed ? (
          <ul className="space-y-1">
            {menuSections.flatMap(section => section.items).map(renderMenuItem)}
          </ul>
        ) : (
