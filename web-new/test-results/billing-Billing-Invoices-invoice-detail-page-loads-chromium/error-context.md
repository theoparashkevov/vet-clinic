...
- Name: billing.spec.ts >> Billing / Invoices >> invoice detail page loads
- Location: e2e/billing.spec.ts:151:3
...
Locator: getByRole('heading', { name: 'INV-2026-0001' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'INV-2026-0001' })
