...
- Name: billing.spec.ts >> Billing / Invoices >> record payment modal opens and validates
- Location: e2e/billing.spec.ts:178:3
...
Call log:
  - waiting for getByRole('button', { name: 'Record Payment' })
